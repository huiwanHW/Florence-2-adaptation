...
class MultiTaskModelFactory(nn.Module):
    def __init__(self, encoder_name: str, encoder_weights: str, task_configs: List[Dict], freeze_stages: int = 4, custom_encoder=None):
        super().__init__()
        ...
        if custom_encoder is not None:
            ...
            # Create a proper FPN decoder for custom Florence encoder
        ...
        elif encoder_name.lower().startswith('florence') and _HAS_FLORENCE:
