...
class FlorenceEncoderAdapter(nn.Module):
    """Adapter to use Florence-style local model as a feature extractor with LoRA applied to ALL layers.
    ...
    - FULL LoRA: Apply LoRA to ALL transformer layers (not just last 30%).
    """
    ...
    def __init__(self, model_path: str = './model/florence-2-base', pretrained: bool = True, feature_dim: int = 256, freeze_stages: int = 4):
        ...
        # Add LoRA to ALL layers of the vision encoder
        self.add_lora_to_all_layers()
    ...
    def add_lora_to_all_layers(self):
        # Add LoRA to ALL layers of the vision encoder
        ...
        # Identify ALL blocks to add LoRA to
        lora_block_indices = []
        current_block_idx = 0
        ...
        print("FULL LoRA: LoRA applied to ALL transformer layers")
...
if __name__ == '__main__':
    ...
    try:
        ...
        print('✅ FlorenceEncoderAdapter (Full LoRA) initialized successfully!')
        ...
        print(f'   - FULL LoRA: LoRA applied to ALL transformer layers')
